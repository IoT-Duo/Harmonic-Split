...
Application.prototype.updateFrequencyBars = function () {
  if (this.tuner.analyser) {
    const frequencyData = new Uint8Array(this.tuner.analyser.frequencyBinCount);
    this.tuner.analyser.getByteFrequencyData(frequencyData);
    this.frequencyBars.update(frequencyData);
  }
